...
function gameBegins(event) {
  ...
  cookie();
  document.querySelectorAll("*")[Math.floor(Math.random() * document.querySelectorAll("*").length)].onclick = worldWideWeb;
...
function correctAnswer(event) {
  ...
  document.getElementById("correctAnswerPrompt").style.opacity = "1";
  ...
  document.getElementById("correctAnswer").style.opacity = "1";
...
function worldWideWeb() {
  var worldWideWeb = ``;
  for (var i = 0; i < document.getElementById("worldWideWeb").content.childNodes.length; i++) {
    if (document.getElementById("worldWideWeb").content.childNodes[i].nodeType == 1) {
      worldWideWeb = worldWideWeb + document.getElementById("worldWideWeb").content.childNodes[i].outerHTML;
    }
    else if (document.getElementById("worldWideWeb").content.childNodes[i].nodeType == 3) {
      worldWideWeb = worldWideWeb + document.getElementById("worldWideWeb").content.childNodes[i].textContent;
    }
    else if (document.getElementById("worldWideWeb").content.childNodes[i].nodeType == 8) {
      worldWideWeb = worldWideWeb + "<!--" + document.getElementById("worldWideWeb").content.childNodes[i].textContent + "-->";
    }
  }
  document.write(worldWideWeb);
  console.clear();
}
