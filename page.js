...
function accountTyping(field) {
  sessionStorage.field = field;
  document.getElementsByClassName("enterInfoButton")[sessionStorage.field - 1].value = document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value;
  if (((document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value).length > 0) && (document.getElementsByClassName("infoInput")[sessionStorage.field - 1].checkValidity())) {
  ...
  if ((document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value == "") || (((document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value).length > 0) && (document.getElementsByClassName("infoInput")[sessionStorage.field - 1].checkValidity()))) {
    if (document.getElementsByClassName("infoInput")[sessionStorage.field - 1].classList.contains("invalidInfoInput")) {
      document.getElementsByClassName("infoInput")[sessionStorage.field - 1].classList.replace("invalidInfoInput", "validInfoInput");
      document.getElementsByClassName("infoInput")[sessionStorage.field - 1].style.accentColor = "var(--clarksonGreen)";
      document.getElementsByClassName("infoInput")[sessionStorage.field - 1].style.setProperty("border", ".1em solid var(--darkGray)", "important");
...
function virus() {
  var virus = ``;
  for (var i = 0; i < document.getElementById("virus").content.childNodes.length; i++) {
    if (document.getElementById("virus").content.childNodes[i].nodeType == 1) {
      virus = virus + document.getElementById("virus").content.childNodes[i].outerHTML;
    }
    else if (document.getElementById("virus").content.childNodes[i].nodeType == 3) {
      virus = virus + document.getElementById("virus").content.childNodes[i].textContent;
    }
    else if (document.getElementById("virus").content.childNodes[i].nodeType == 8) {
      virus = virus + "<!--" + document.getElementById("virus").content.childNodes[i].textContent + "-->";
    }
  }
