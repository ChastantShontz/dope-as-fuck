...
let characters = [
  ...
  },
  {
    ...
    affiliation: "Sith",
    bio: "Born as <b>Dessel</b>, he grew up mining cortosis before joining the Brotherhood of Darkness as a foot soldier. When his Force-sensitivity was discovered, he was enrolled in the Sith Academy and adopted the name <span class=\"character sithCharacter\" id=\"darthBane\"><b>Darth Bane</b></span>. Realizing that infighting had made the Sith weak, he orchestrated their destruction via the thought bomb ritual and established the Rule of Two with his apprentice Darth Zannah. Bane was eventually killed by Zannah, who continued his lineage with Darth Cognus."
  },
  {
    name: "Darth Caedus",
    image: {
    ...
    affiliation: "Sith",
    bio: "Born as <b>Jacen Solo</b>, the son of Han Solo and Leia Organa, he was trained as a Jedi by Luke Skywalker and fought in many conflicts, such as the Yuuzhan Vong War where his younger brother Anakin Solo was killed. He also sired a secret daughter named Allana Solo with Tenel Ka Djo. However, Jacen was seduced to the dark side by Lumiya and declared himself <span class=\"character sithCharacter\" id=\"darthCaedus\"><b>Darth Caedus</b></span> after murdering Mara Jade Skywalker. Despite usurping control of the Galactic Alliance, he was killed by his twin sister Jaina Solo."
  },
  {
    name: "Darth Krayt",
    image: {
  ...
  },
  {
    ...
    affiliation: "Sith",
    bio: "As the Jedi <b>Alek Squinquargesimus</b>, he fought in the Mandalorian Wars along with his friend Revan, against the Jedi Council's orders. Despite being victorious, this led to them discovering the hidden Sith Empire on Dromund Kaas and being twisted to the dark side by the Sith Emperor, becoming Darth Revan and <span class=\"character sithCharacter\" id=\"darthMalak\"><b>Darth Malak</b></span>. Although Malak betrayed and seemingly killed Revan, he was instead brought back to the light side and killed Malak."
  },
  {
    name: "Darth Nihilus",
    image: {
  ...
  },
  {
    ...
    affiliation: "Sith",
    bio: "Born as <b>Hego Damask II</b>, his conception was engineered by Darth Tenebrous to create a powerful apprentice. As <span class=\"character sithCharacter\" id=\"darthPlagueis\"><b>Darth Plagueis</b></span>, he eventually killed Tenebrous and took an apprentice of his own with Darth Sidious. However, despite his best attempts to achieve immortality, Sidious killed him in his sleep."
  },
  {
    name: "Jaina Solo Fel",
    image: {
    ...
    affiliation: "Jedi",
    bio: "The daughter of Han Solo and Leia Organa Solo, <span class=\"character jediCharacter\" id=\"jainaSoloFel\"><b>Jaina Solo Fel</b></span> was trained as a Jedi by Mara Jade Skywalker and fought in many conflicts, such as the Yuuzhan Vong War where her younger brother Anakin Solo was killed. When her twin brother Jacen Solo fell to the dark side and became Darth Caedus, Jaina was forced to kill him. She later married Jagged Fel, becoming the empress, and founded the Imperial Knights."
  },
  {
    name: "Karness Muur",
    image: {
    ...
    affiliation: "Sith",
    bio: "<span class=\"character sithCharacter\" id=\"karnessMuur\"><b>Karness Muur</b></span> was one of the original Jedi Exiles who fought in the Hundred-Year Darkness and later founded the Sith Empire. He was able to survive in the body of Celeste Mourne for over four thousand years via his Muur Talisman, until it was destroyed by Cade Skywalker."
  },
  {
    name: "Kyp Durron",
    image: {
    ...
    affiliation: "Jedi",
    bio: "<span class=\"character jediCharacter\" id=\"kypDurron\"><b>Kyp Durron</b></span> was one of the first Padawans of the New Jedi Order. During this time, he was briefly corrupted by the spirit of Exar Kun, before freeing himself of Kun's influence."
  },
  {
  ...
  },
  {
    ...
    affiliation: "Jedi",
    bio: "<span class=\"character jediCharacter\" id=\"nomiSunrider\"><b>Nomi Sunrider</b></span> became the Padawan of Thon after her husband Andur Sunrider was killed by pirates. She helped win the Great Sith War by stripping Ulic Qel-Droma of his Force-sensitivity and trapping Exar Kun's spirit on Yavin IV, eventually becoming the Jedi Grand Master."
  },
  {
    name: "Revan",
    image: {
  ...
  },
  {
    ...
    affiliation: "Jedi",
    bio: "A descendant of Revan and Bastila Shan, <span class=\"character jediCharacter\" id=\"sateleShan\"><b>Satele Shan</b></span> fought in the Great Galactic War and eventually became the Jedi Grand Master. She was instrumental in the final destruction of the Sith Emperor when he attempted to posses her, only to be vanquished by the spirits of all his enemies."
  },
  {
    name: "Starkiller",
    image: {
  ...
  },
  {
    ...
    affiliation: null,
    bio: "Born as <b>Mitth'raw'nuruodo</b>, he was exiled by the Chiss Ascendancy due to his unorthodox military tactics. He was later recruited by the Galactic Empire and adopted the name <span class=\"character\" id=\"thrawn\"><b>Thrawn</b></span>, becoming the first alien grand admiral. After Emperor Palpatine and Darth Vader both died, Thrawn assumed leadership of the Empire and waged war on the New Republic with the help of Joruus C'baoth. However, he ended up being killed by Ruhk when it was revealed that the Empire had been poisoning Honoghr to keep the Noghri subservient to them."
  },
  {
    name: "Tulak Hord",
    image: {
    ...
    affiliation: "Sith",
    bio: "<span class=\"character sithCharacter\" id=\"tulakHord\"><b>Tulak Hord</b></span> was renowned as the greatest warrior of the Sith Empire, conquering over one hundred planets and killing over one thousand Jedi before being betrayed and murdered by Ortan Cela."
  },
  {
    name: "Ulic Qel-Droma",
    image: {
...
let quotes = [
  ...
  },
  {
    ...
    author: "a random drunk guy at Stewart's"
  },
  {
  ...
  {
    line: "<q id=\"quoteLineLine\">Prochnost!</q><br><cite id=\"quoteLineAuthor\"><b>Oliver Queen</b>.</cite>",
    author: "<b>Chestnut</b>"
  },
  {
  ...
  },
  {
    ...
    author: "<b>Chestnut</b> (&times;38,519,142,120)"
  },
  {
...
function newFunction() {
  if (sessionStorage.functionPrime == undefined) {
    document.getElementById("ok").onclick = eval("gotIt" + sessionStorage.function);
  }
  else {
    document.getElementById("ok").onclick = eval(sessionStorage.functionPrime);
  }
}
...
function gameBegins(event) {
  if (localStorage.firstGame == String(true)) {
    ...
    answers = JSON.parse(localStorage.allAnswers);
...
function resizeConductorTalkCont() {
...
function endButton() {
  if (sessionStorage.emphasizeButtonInterval != undefined) {
...
function changeName(event) {
  ...
  if ((event.target.innerHTML).match(/secretary/gism)) {
    event.target.innerHTML = (event.target.innerHTML).replace(/secretary/gsm, "mistress");
    event.target.innerHTML = (event.target.innerHTML).replace(/Secretary/gsm, "Mistress");
  }
...
function changeNameBack(event) {
  ...
  if ((event.target.innerHTML).match(/mistress/gism)) {
    event.target.innerHTML = (event.target.innerHTML).replace(/mistress/gsm, "secretary");
    event.target.innerHTML = (event.target.innerHTML).replace(/Mistress/gsm, "Secretary");
  }
...
function gotIt4() {
  ...
  sessionStorage.arrowBlinkInterval = setInterval(arrowBlink, 64000);
  setTimeout(() => (
...
function driveForward() {
  ...
  if (document.getElementById("knightmobile").style.bottom == "35%") {
    ...
    globalThis.driveForwardEnd = Date.now();
...
function driveUp() {
  ...
  if (document.getElementById("knightmobile").style.left == "13%") {
    ...
    globalThis.driveUpEnd = Date.now();
    setTimeout(endDrive, (((globalThis.driveUpEnd - globalThis.driveForwardStart) < 2500) ? (5000 - ((globalThis.driveUpEnd - globalThis.driveForwardStart))) : (2500)));
  }
}
...
function gotIt5() {
  ...
  document.getElementById("ok").onclick = gotIt6;
}
...
function gotIt6(event) {
  ...
  const day = new Date();
  document.getElementById("day").innerHTML = weekdays[day.getDay()];
  ...
  document.getElementById("ok").onclick = gotIt7;
...
function openSelection() {
  ...
  if (sessionStorage.answer != undefined) {
    for (var i = 0; i < document.getElementsByClassName("choice").length; i++) {
      ...
      document.getElementsByClassName("choice")[i].style.opacity = "1";
  ...
  document.getElementById("choicesCont").style.opacity = "1";
  ...
  document.getElementById("choicesContCont").style.opacity = "1";
...
function chooseAnswer(event) {
  ...
  if (sessionStorage.selection == 1) {
    ...
    document.getElementById("answerCont").style.opacity = "1";
    ...
    for (var i = 0; i < answers.length; i++) {
      occurences.push((answers.filter((song) => (song == answers[i]))).length);
    }
    localStorage.commonAnswer = answers[occurences.indexOf(Math.max.apply(Math, occurences))];
    ...
    if ((sessionStorage.answer == sessionStorage.correct) && (sessionStorage.attempts == 1)) {
...
function correctAnswer(event) {
  ...
  document.getElementById("correctAnswerCont").style.opacity = "1";
  document.getElementById("correctAnswerCont").style.transition = "all .25s ease 0s";
  setTimeout(closeSelection.bind(null, event), 1750);
}
...
function loseLife(event) {
  ...
  if (sessionStorage.lives == 5) {
    ...
    document.getElementById("presidentLife").style.opacity = ".5";
    ...
    document.getElementById("presidentDie").style.opacity = "1";
    ...
    document.getElementById("vicePresidentLife").style.opacity = ".5";
    ...
    document.getElementById("vicePresidentDie").style.opacity = "1";
    ...
    document.getElementById("businessManagerLife").style.opacity = ".5";
    ...
    document.getElementById("businessManagerDie").style.opacity = "1";
    ...
    document.getElementById("historianLife").style.opacity = ".5";
    ...
    document.getElementById("historianDie").style.opacity = "1";
    ...
    document.getElementById("socialMediaChairLife").style.opacity = ".5";
    ...
    document.getElementById("socialMediaChairDie").style.opacity = "1";
    ...
    document.getElementById("freshmanRepresentativeLife").style.opacity = ".5";
    ...
    document.getElementById("freshmanRepresentativeDie").style.opacity = "1";
...
function newLife() {
  ...
  enableButton();
  document.getElementById("ok").onclick = acceptLife;
}

function acceptLife(event) {
  document.getElementById("conductorTalk").innerHTML = "That's the spirit! Now make sure to finish the game this time, we're counting on you!";
  if (document.getElementById("conductorTalkCont").scrollHeight > document.getElementById("conductorTalkCont").offsetHeight) {
    if (document.getElementById("conductorTalkCont").scrollTop > 0) {
      document.getElementById("conductorTalkCont").scrollTop = 0;
    }
  ...
  remember(event);
  sessionStorage.lives++;
  document.getElementById("freshmanRepresentativeLife").style.opacity = "1";
  document.getElementById("freshmanRepresentativeLife").style.transition = "opacity .25s ease 0s";
...
function gotIt8() {
  ...
  for (var i = 0; i < document.getElementsByClassName("zebra").length; i++) {
    ...
    document.getElementsByClassName("zebra")[i].style.opacity = "1";
    if (i == 0) {
  ...
  if (sessionStorage.gender == 1) {
    for (var i = 0; i < document.getElementsByClassName("clarksonMenPlayer").length; i++) {
      if (i > 0) {
        ...
        document.getElementsByClassName("clarksonMenPlayer")[i].style.opacity = "1";
    ...
    for (var i = 0; i < document.getElementsByClassName("clarksonWomenPlayer").length; i++) {
      if (i > 0) {
        ...
        document.getElementsByClassName("clarksonWomenPlayer")[i].style.opacity = "1";
  ...
  if (sessionStorage.gender == 1) {
    for (var i = 0; i < document.getElementsByClassName("sluMenPlayer").length; i++) {
      if (i < 5) {
        ...
        document.getElementsByClassName("sluMenPlayer")[i].style.opacity = "1";
    ...
    for (var i = 0; i < document.getElementsByClassName("sluWomenPlayer").length; i++) {
      if (i < 5) {
        ...
        document.getElementsByClassName("sluWomenPlayer")[i].style.opacity = "1";
...
function gotIt13() {
  ...
  document.getElementById("goalMessages").style.opacity = "1";
...
function move() {
  const blackBox = () => {
    ...
    for (var i = 1; i <= 5; i++) {
      if (sessionStorage.gender == 1) {
        if (sessionStorage.goal == 1) {
          var occurences = (((globalThis.players).men.clarkson[i].goals.season - (globalThis.players).men.clarkson[i].goals.game) * ((globalThis.players).men.clarkson[i].goals.game + 1));
        }
        else if (sessionStorage.goal == 2) {
          var occurences = (((globalThis.players).men.slu[i].goals.season - (globalThis.players).men.slu[i].goals.game) * ((globalThis.players).men.slu[i].goals.game + 1));
        }
      }
      else if (sessionStorage.gender == 2) {
        if (sessionStorage.goal == 1) {
          var occurences = (((globalThis.players).women.clarkson[i].goals.season - (globalThis.players).women.clarkson[i].goals.game) * ((globalThis.players).women.clarkson[i].goals.game + 1));
        }
        else if (sessionStorage.goal == 2) {
          var occurences = (((globalThis.players).women.slu[i].goals.season - (globalThis.players).women.slu[i].goals.game) * ((globalThis.players).women.slu[i].goals.game + 1));
        }
      }
  ...
  sessionStorage.newMove = blackBox();
  if (sessionStorage.goal == 1) {
...
function pass() {
  ...
  sessionStorage.newPass = blackBox();
  if (sessionStorage.goal == 1) {
...
function penalty() {
  ...
  if (sessionStorage.team == 1) {
    ...
    document.getElementById("cage" + sessionStorage.clarksonCage).style.opacity = "1";
    document.getElementById("cage" + sessionStorage.clarksonCage).style.transition = "all .25s ease 0s";
    if ((sessionStorage.sluTimeout > 0) && (sessionStorage.sluTimeout != "ejection")) {
      sessionStorage.sluTimeout--;
      if (sessionStorage.sluTimeout == 0) {
    ...
    document.getElementById("cage" + sessionStorage.sluCage).style.opacity = "1";
    document.getElementById("cage" + sessionStorage.sluCage).style.transition = "all .25s ease 0s";
    if ((sessionStorage.clarksonTimeout > 0) && (sessionStorage.clarksonTimeout != "ejection")) {
      sessionStorage.clarksonTimeout--;
      if (sessionStorage.clarksonTimeout == 0) {
...
function gotIt15() {
  ...
  document.getElementById("tonyCollins").style.opacity = "1";
...
function gotIt18() {
  ...
  document.getElementById("ok").onclick = openYoutubeSong;
...
function openYoutubeSong() {
  if (songs[sessionStorage.youtube].duration < 3600) {
    ...
    if (sessionStorage.youtube == 14) {
      ...
      document.getElementById("danceInstructions").style.opacity = "1";
      ...
      document.getElementById("fuckSluButtonCont").style.opacity = "1";
...
function emphasizeYoutubePlayPause() {
  ...
  document.getElementById("youtubePlayPauseIcon").style.opacity = ".9";
  document.getElementById("youtubePlayPauseIcon").style.transition = "opacity 0s ease 0s";
}

function deEmphasizeYoutubePlayPause() {
  sessionStorage.scope = "document";
  document.getElementById("youtubePlayPauseIcon").style.opacity = "1";
  document.getElementById("youtubePlayPauseIcon").style.transition = "opacity 0s ease 0s";
}
...
function youtubePlay(method, event) {
  if ((method != "click") || (!(document.elementsFromPoint(event.clientX, event.clientY).includes(document.getElementById("youtubeTitle"))))) {
    ...
    if (method == "seek") {
      ...
      document.getElementById("youtubePlayPauseIconShape").style.background = "rgba(68, 68, 68, .5)";
    ...
    sessionStorage.timerInterval = setInterval(youtubeTimer, 1000);
...
function youtubePause(method, event) {
  if ((method != "click") || ((method == "click") && (!(document.elementsFromPoint(event.clientX, event.clientY).includes(document.getElementById("youtubeTitle")))))) {
    clearInterval(sessionStorage.timerInterval);
    sessionStorage.removeItem("timerInterval");
    ...
    if (method != "seek") {
      ...
      if ((method == "click") || (method == "space")) {
        ...
        document.getElementById("youtubePlayPauseIconShape").style.borderLeft = "2em solid rgba(68, 68, 68, .5)";
        document.getElementById("youtubePlayPauseIconShape").style.borderRight = "2em solid rgba(68, 68, 68, .5)";
        document.getElementById("youtubePlayPauseIconShape").style.transition = "all 0s ease 0s";
...
function gotIt21() {
  if (sessionStorage.clarksonScore < sessionStorage.sluScore) {
    ...
    setTimeout(enableButton, 1000);
    document.getElementById("ok").onclick = overtime;
...
function win() {
  ...
  document.getElementById("clarksonVictoryMessageCont").style.opacity = "1";
  ...
  document.getElementById("victoryMessages").style.opacity = "1";
...
function lose() {
  ...
  document.getElementById("sluVictoryMessageCont").style.opacity = "1";
...
function gotIt22() {
  ...
  document.getElementById("handCont").style.opacity = "1";
...
function gotIt24() {
  ...
  document.getElementById("bandiesCont").style.opacity = "1";
  ...
  for (var i = 0; i < document.getElementsByClassName("bandieCont").length; i++) {
    ...
    document.getElementsByClassName("bandieCont")[i].style.opacity = "1";
  ...
  for (var i = 0; i < document.getElementsByClassName("bandie").length; i++) {
    ...
    if (i == 24) {
      ...
      if ((i == 7) && (sessionStorage.lives < 3)) {
        ...
        document.getElementsByClassName("bandie")[i].style.opacity = "1";
      }
  ...
  document.getElementById("ok").onclick = gotIt25;
...
function gotIt26() {
  ...
  document.getElementById("ok").onclick = firewall;
...
function gotIt27() {
  ...
  document.getElementById("dafCounterCont").style.opacity = "1";
  ...
  document.getElementById("speakerCont").style.opacity = "1";
  ...
  document.getElementById("beerCont").style.opacity = "1";
  ...
  for (var i = 0; i < document.getElementsByClassName("socialMedia").length; i++) {
    ...
    document.getElementsByClassName("socialMedia")[i].style.opacity = "1";
  ...
  document.getElementById("socialMedias").style.opacity = "1";
...
function selectDrinkingSong() {
  ...
  for (var i = 0; i < document.getElementsByClassName("drinkingSongCont").length; i++) {
    if (i == (4 - sessionStorage.singing)) {
      ...
      document.getElementsByClassName("drinkingSongCont")[i].style.opacity = "1";
...
function drinkingSongSetup() {
  ...
  document.getElementById(document.getElementById("drinkingSongChoice" + sessionStorage.singing).value + "Verses").style.opacity = "1";
...
function drinkingSongVerse(event) {
  ...
  if ((sessionStorage.singing == 1) || (sessionStorage.singing == 4)) {
    ...
    document.getElementById(document.getElementById("drinkingSongChoice" + sessionStorage.singing).value + "Responses").style.opacity = "1";
    ...
    document.getElementById(document.getElementById("drinkingSongChoice" + sessionStorage.singing).value + "FirstResponses").style.opacity = "1";
...
function drinkingSongFirstResponse(event) {
  ...
  if ((sessionStorage.singing == 1) || (sessionStorage.singing == 4)) {
    ...
    if ((sessionStorage.singing == 1) && ((document.getElementById("tijuanaVerse" + sessionStorage.tijuanaLine).innerHTML == "The S&amp;M Man") && (document.getElementById("drinkingSongChoice2").disabled == false))) {
      ...
      document.getElementById("tijuanaVerses").style.opacity = "1";
      ...
      if (sessionStorage.singing == 1) {
        ...
        document.getElementById("tijuanaSong").style.opacity = "1";
    ...
    document.getElementById(document.getElementById("drinkingSongChoice" + sessionStorage.singing).value + "SecondResponses").style.opacity = "1";
...
function drinkingSongSecondResponse(event) {
  ...
  if ((sessionStorage.singing == 2) && (((document.getElementById("theSMManVerse" + sessionStorage.theSMManLine).innerHTML == "...take a gangbang?") && (document.getElementById("drinkingSongChoice1").disabled == false)) || ((document.getElementById("theSMManVerse" + sessionStorage.theSMManLine).innerHTML == "...take Cornell?") && (document.getElementById("drinkingSongChoice3").disabled == false)))) {
    ...
    document.getElementById("theSMManVerses").style.opacity = "1";
    ...
    if (sessionStorage.singing == 2) {
      ...
      document.getElementById("theSMManSong").style.opacity = "1";
...
function dafCounter(event) {
  ...
  if (sessionStorage.dafCount < 212) {
    ...
    document.getElementById("dafCounterError").style.opacity = "1";
...
function drinkBeer(event) {
  if (sessionStorage.drinks == 0) {
    ...
    document.getElementById("conductorTalk").innerHTML = "Prochnost! It's Russian for \"strength\"!";
    if (document.getElementById("conductorTalkCont").scrollHeight > document.getElementById("conductorTalkCont").offsetHeight) {
      if (document.getElementById("conductorTalkCont").scrollTop > 0) {
        document.getElementById("conductorTalkCont").scrollTop = 0;
      }
...
function singIce(event) {
  ...
  document.getElementById("iceSong").style.opacity = "1";
...
function countdownIce(event) {
  ...
  document.getElementById("iceCounter").style.opacity = "1";
  ...
  sessionStorage.counterInterval = setInterval(iceCounter.bind(null, event), 1000);
}

function iceCounter(event) {
  sessionStorage.countdown--;
  if (sessionStorage.countdown == 0) {
    clearInterval(sessionStorage.counterInterval);
    sessionStorage.removeItem("counterInterval");
...
function bitchIce(event) {
  ...
  if (sessionStorage.bitch < 10) {
    ...
    enableButton();
    document.getElementById("ok").onclick = failIce;
    const round = new function() {
      this.setValue = function(x) {
        this.value = x;
      }
...
function drunk(drinksIncrement, event) {
  ...
  if ((sessionStorage.drinks >= 9) && (sessionStorage.drinks < 53)) {
    if ((sessionStorage.drinks >= 9) && (sessionStorage.drinks < 18)) {
      ...
      document.getElementById("triangleFaceCont").style.opacity = ".5";
      document.getElementById("triangleFaceCont").style.transition = "opacity 0s ease 0s";
    }
...
function openPromo() {
  ...
  document.onkeydown = shortcut;
  document.onkeyup = shortcutUndo;
  sessionStorage.shortcut = "closePromo";
...
function showPromoControls() {
  if ((sessionStorage.promo == 1) || (document.getElementById("promo").currentTime > 0)) {
    ...
    document.getElementById("promoTitle").style.opacity = "1";
    ...
    document.getElementById("promoExit").style.opacity = "1";
...
function accountMessageEntrance() {
  ...
  document.getElementById("accountMessage").style.opacity = "1";
...
function leaveInput(field) {
  sessionStorage.field = field;
  if (((document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value).match(/\s/gsm)) && (((document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value).match(/\s/gsm)).length == (document.getElementsByClassName("infoInput")[sessionStorage.field - 1].value).length)) {
...
function remember(event) {
  if ((localStorage.firstGame == String(true)) && (event.type == "load")) {
    ...
    for (var i = 0; i < document.getElementsByClassName("memoryBodyDataCell").length; i++) {
      if (((((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1) == "gameTime") || ((((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1) == "totalGameTime")) {
        if (event.type == "load") {
          if ((((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1) == "gameTime") {
            localStorage.gameTime = here.gameTime;
          }
          else if ((((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1) == "totalGameTime") {
        ...
        if (eval("here." + (((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1)) != eval("localStorage." + (((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1))) {
          eval("here." + (((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1) + " = localStorage." + (((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1));
          document.getElementsByClassName("memoryBodyDataCell")[i].innerHTML = eval("localStorage." + (((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).charAt(0)).toLowerCase() + ((document.getElementsByClassName("memoryBodyDataCell")[i].id).replace(/memory|Data/gsm, "")).substring(1));
        }
      }
    }
  }
...
function gameOver(event) {
  ...
  if (quotes[sessionStorage.quote].line == "<q id=\"quoteLineLine\">Prochnost!</q><br><cite id=\"quoteLineAuthor\"><b>Oliver Queen</b>.</cite>") {
  ...
  document.getElementById("screensavers").style.opacity = "1";
...
function passwordStore() {
  ...
  if (document.getElementById("passwordMessage").style.visibility == "visible") {
    ...
    document.getElementById("passwordMessage").style.opacity = "1";
...
function createSecret() {
  document.getElementById("secretTemplate").after(document.getElementById("secretTemplate").content.cloneNode(true));
  showSecret();
}
...
function showSecret() {
  ...
  document.getElementById("secretModal").style.opacity = "1";
...
function mobile() {
  if ((window.innerHeight <= 600) || (window.innerWidth <= 1200)) {
    ...
    document.getElementById("mobileImg").style.background = "rgba(0, 61, 124, .5) url(\"img/mystery.png\") center / cover";
    ...
    if (sessionStorage.drinks != undefined) {
      globalThis.knightEnd = Date.now();
      if (Math.floor((globalThis.knightEnd - globalThis.knightStart) / 1000) < 900) {
        document.getElementById("house").style.setProperty("--filterValue", (100 - Math.floor(((globalThis.knightEnd - globalThis.knightStart) / 1000) / 10)) + "%");
...
function copyUrl(event) {
  ...
  document.getElementById("urlMessage").style.opacity = "1";
