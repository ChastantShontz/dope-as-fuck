...
let characters = [
  ...
  },
  {
    ...
    bio: "<span class=\"character sithCharacter\" id=\"jacenSolo\">Jacen Solo</span> was the son of Han Solo and Leia Organa. He was trained as a Jedi by Luke Skywalker and fought in many conflicts such as the Yuuzhan Vong War, which he ended by killing the true mastermind behind it, Onimi. However, Jacen was seduced to the dark side by Lumiya and declared himself <span class=\"character sithCharacter mainCharacter sithMainCharacter\" id=\"darthCaedus\"><a href=\"https://starwars.fandom.com/wiki/Darth_Caedus\" hreflang=\"en-us\" charset=\"utf-8\" rel=\"external noopener noreferrer nofollow\" target=\"_blank\" referrerpolicy=\"strict-origin-when-cross-origin\" type=\"text/html\" title=\"Darth Caedus on Wookieepedia\" class=\"characterLink sithLink\" id=\"darthCaedusLink\" role=\"link\" aria-label=\"Read some more about Darth Caedus\">Darth Caedus</a></span> in an attempt to prevent a worse future from coming to pass. Despite managing to briefly usurp control of the Galactic Alliance, he was killed by his twin sister Jaina Solo."
  },
  {
    name: "Darth Krayt",
